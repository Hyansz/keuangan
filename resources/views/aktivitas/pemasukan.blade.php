...
@section('topbar')
    <div class="d-flex align-items-center justify-content-between flex-wrap bg-white mb-4 static-top p-4 shadow">
        <h1 class="h3 mb-0 text-gray-800">Aktivitas Pemasukan</h1>
...
@section('content3')
    ...
    <div class="container px-4 py-4">
        <div class="bg-white p-4 rounded-4 shadow-sm">
            ...
            <form method="GET" action="{{ route('aktivitas.pemasukan') }}" class="row g-3 mb-4">
                <div class="col-md-4">
                    ...
                    <tbody>
                        @forelse ($pemasukan as $item)
                            <tr class="text-center">
                                ...
                                <td class="text-success fw-semibold">Rp {{ number_format($item->pemasukan, 0, ',', '.') }}</td>
